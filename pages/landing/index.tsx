...
const Landing = ({
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      {tab !== 'login' && <SignUp userName={userName} setUserName={setUserName} email={email} setEmail={setEmail} password={password} setPassword={setPassword} saveSignUpData={saveSignUpData} />}
    </div>
    </>
  )
}
